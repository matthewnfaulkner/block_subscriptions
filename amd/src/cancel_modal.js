...
define(['jquery', 'core/str', 'core/modal_factory',
    ...
    function updateModalBody(formdata) {
        ...
        if (typeof enrolId !== "undefined" && typeof userEnrolId !== "undefined") {
            var params = {
    ...
    function processModalForm(e) {
        ...
        // Form data.
        var cancelform = modalObj.getRoot().find('form').serialize();
        const formData = modalObj.getRoot().find('form').serializeArray();
        ...
        // Submit form via ajax.
        ajax.call([{
            methodname: 'block_subscriptions_unenrol_self',
            args: {
                ueid: ueid
            },
        }])[0].done(function() {
